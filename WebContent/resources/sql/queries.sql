...
CREATE TABLE usuario_auth_historico (
	id NUMBER(11) NOT NULL,
	id_usuario NUMBER(11) NULL,
	email VARCHAR2(80) NOT NULL,
	ip VARCHAR2(80) NOT NULL,
	user_agent VARCHAR(120) NOT NULL,
	created_at DATE NOT NULL,
    CONSTRAINT usuario_auth_pk PRIMARY KEY (id),
    CONSTRAINT usuario_auth_usuario_fk FOREIGN KEY (id_usuario) REFERENCES usuarios(id)
);

CREATE SEQUENCE usuario_auth_seq
    INCREMENT BY 1
    START WITH 1
    NOCACHE;
...
CREATE TABLE usuario_fez_receita (
    id_receita NUMBER(11) NOT NULL,
    id_usuario NUMBER(11) NOT NULL,
	created_at DATE NOT NULL,
	deleted_at DATE NULL,
...
CREATE TABLE pesquisa (
	id NUMBER(11) NOT NULL,
	id_usuario NUMBER(11) NULL,
	termo VARCHAR2(80) NULL,
	ip VARCHAR2(80) NOT NULL,
	user_agent VARCHAR2(80) NOT NULL,
	created_at DATE NOT NULL,
    CONSTRAINT pesquisa_pk PRIMARY KEY (id),
    CONSTRAINT pesquisa_usuario_fk FOREIGN KEY (id_usuario) REFERENCES usuarios(id)
);

CREATE SEQUENCE pesquisa_seq
    INCREMENT BY 1
    START WITH 1
    NOCACHE;

CREATE TABLE pesquisa_ingredientes (
    id_pesquisa NUMBER(11) NOT NULL,
    id_ingrediente NUMBER(11) NOT NULL,
    CONSTRAINT pesquisa_ing_pk PRIMARY KEY (id_pesquisa, id_ingrediente),
    CONSTRAINT pesquisa_ing_pes_fk FOREIGN KEY (id_pesquisa) REFERENCES pesquisa(id),
    CONSTRAINT pesquisa_ing_ing_fk FOREIGN KEY (id_ingrediente) REFERENCES ingredientes(id)
);

CREATE TABLE pesquisa_abriu_receita (
    id_pesquisa NUMBER(11) NOT NULL,
    id_receita NUMBER(11) NOT NULL,
	created_at DATE NOT NULL,
    CONSTRAINT pesquisa_rec_pk PRIMARY KEY (id_pesquisa, id_receita),
    CONSTRAINT pesquisa_rec_pes_fk FOREIGN KEY (id_pesquisa) REFERENCES pesquisa(id),
    CONSTRAINT pesquisa_rec_rec_fk FOREIGN KEY (id_receita) REFERENCES receitas(id)
);
